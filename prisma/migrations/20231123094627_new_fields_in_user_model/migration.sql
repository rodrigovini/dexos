...
INSERT INTO "new_User" ("address", "city", "createAt", "email", "facebook", "fullName", "hashedPassword", "id", "instagram", "linkedin", "phoneNumber", "postalCode", "salt", "twitter", "username", "whatsappNumber") SELECT "address", "city", "createAt", "email", "facebook", "fullName", "hashedPassword", "id", "instagram", "linkedin", "phoneNumber", "postalCode", "salt", "twitter", "username", "whatsappNumber" FROM "User";
DROP TABLE "User";
